...
const THEME_PRESETS: Record<ThemePresetKey, ThemePreset> = {
	...
	warm: {
		...
		circleEmoji: "🟠",
		palette: [
			"#FFFFFF", "#FFF8F4", "#FEF0E6", "#FDDCC8",
			"#F9C9A8", "#F5AD80", "#EB7035", "#D45F25",
			"#B84E18", "#9A3E0E", "#7A2E08", "#000000",
		],
		defaults: {
			markdownBgColor: "#FFFFFF",
			chatRBubbleColor: "#FDDCC8",
			chatLBubbleColor: "#FDDCC8",
			tableHeaderBorderColor: "#F5AD80",
		},
		css: {
			textColor: "rgb(40, 28, 18)",
			headingColor: "rgb(50, 35, 22)",
			borderColor: "rgb(245, 173, 128)",
			qBorderColor: "rgb(249, 201, 168)",
			linkColor: "#D45F25",
			inlineCodeBg: "#FDE3D0",
			inlineCodeColor: "#9A3E0E",
			emphasisColor: "#B84E18",
			codeBlockLightBg: "#FEF0E6",
		},
	},
	ocean: {
		label: "Ocean",
